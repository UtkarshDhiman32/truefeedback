...
//     // FIX 1: ObjectId ko string mein convert kiya taaki live filter sahi se kaam kare 🎯
//     const handleDeleteMessage = (messageId: string) => {
//         setMessages(messages.filter((message) => message._id.toString() !== messageId));
//     };
...
//                         value={profileUrl}
//                         disabled
//                         className="input input-bordered w-full p-2 mr-2 text-black bg-gray-100"
//                     />
//                     <Button onClick={copyToClipboard}>Copy</Button>
//                 </div>
//             </div>
...
//                         <MessageCard
//                             // FIX 2: key prop ke liye bhi string explicit return kiye 🎯
//                             key={message._id.toString()}
//                             message={message}
//                             onMessageDelete={handleDeleteMessage}
//                         />
